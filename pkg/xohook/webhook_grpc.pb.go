...
const (
	WebhookService_SendWebhook_FullMethodName = "/xohook.WebhookService/SendWebhook"
)
...
func (c *webhookServiceClient) SendWebhook(ctx context.Context, in *EventReq, opts ...grpc.CallOption) (*EventResp, error) {
	out := new(EventResp)
	err := c.cc.Invoke(ctx, WebhookService_SendWebhook_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WebhookService_SendWebhook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WebhookService_SendWebhook_FullMethodName,
	}
...
var WebhookService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "xohook.WebhookService",
	...
	Metadata: "pkg/xohook/webhook.proto",
}
